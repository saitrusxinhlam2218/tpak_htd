...
*                           S C C S   I N F O                               *
*                                                                           *
* @(#)  syncdb_strdefs.h; Rel: 10.1.2.1; Get date: 4/20/95 at 11:49:46
* @(#)  Last delta: 12/2/94 at 18:48:28
* @(#)  SCCS File: /taxi/sccs/s.syncdb_strdefs.h
*                                                                           *
* Copyright (c) 1990 - MDI Seattle                                          *
*                                                                           *
*****************************************************************************/
#ident "@(#) head:syncdb_strdefs.h/usr/users/brian/samplan/src/include	10.1.2.1"
