...
/*
/* These are language dependant and are now defined in language.h
/* #define		UI_MENU		'M'		/* MENU on display */
/* #define		UI_SCREEN	'S'		/* screen on display */
/**/
