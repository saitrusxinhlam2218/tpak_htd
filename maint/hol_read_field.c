...
*                 RCS INFO
*
*  @(#)  $RCSfile: hol_read_field.c,v $
*  @(#)  $Revision: 1.2 $
*  @(#)  $Date: 1996/09/06 14:08:36 $
*  @(#)  $Author: jwelch $
*  @(#)  $Source: /taxi-scan/taxi_proj/cvs/taxi-scan/src/maint/hol_read_field.c,v $
*
*  Copyright (c) 1994 - MobileSoft Consulting, Inc. Woodinville WA
*
***********************************************************************/

static char rcsid[] = "$Id: hol_read_field.c,v 1.2 1996/09/06 14:08:36 jwelch Exp $";
