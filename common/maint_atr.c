static char sz__FILE__[]="@(#)maint_atr.c	10.1(ver) Date Release 12/2/94" ;
 /****************************************************************************
 *                                                                           *
 *                           S C C S   I N F O                               *
 *                                                                           *
 * @(#)  maint_atr.c; Rel: 10.1.0.0; Get date: 4/18/95 at 16:33:08
 * @(#)  Last delta: 12/2/94 at 11:37:45
 * @(#)  SCCS File: /taxi/sccs/s.maint_atr.c
 *                                                                           *
 *****************************************************************************/
 ...
 *		in reverse again)
 */
maint_norm_to_rev(win_fld, ptr_scr_fld, piu)
 ...
 * mode
 */
maint_rev_to_norm(win_fld,ptr_scr_fld,piu)
	WINDOW *win_fld;	/* window to be used */
	struct scr_flds *ptr_scr_fld;	/* pointer to appropriate piu struct */
	int piu;	/* # of the field */
{
 ...
 * mode
 */
maint_revund_to_norm(win_fld,ptr_scr_fld,piu)
	WINDOW *win_fld;	/* window to be used */
	struct scr_flds *ptr_scr_fld;	/* pointer to appropriate piu struct */
	int piu;	/* # of the field */
{
