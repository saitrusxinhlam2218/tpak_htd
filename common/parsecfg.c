...
*                 RCS INFO
*
*  @(#)  $RCSfile: parsecfg.c,v $
*  @(#)  $Revision: 1.2 $
*  @(#)  $Date: 2001/10/03 17:52:47 $
*  @(#)  $Author: taxiadm $
*  @(#)  $Source: /taxi-scan/taxi_proj/cvs/taxi-scan/src/common/parsecfg.c,v $
*
*  Copyright (c) 2000 - MobileSoft Consulting, Inc. Dublin OH
*
***********************************************************************/

static char rcsid[] = "$Id: parsecfg.c,v 1.2 2001/10/03 17:52:47 taxiadm Exp $";
...
/* $Id: parsecfg.c,v 1.2 2001/10/03 17:52:47 taxiadm Exp $ */
