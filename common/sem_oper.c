static char sz__FILE__[]="@(#)sem_oper.c	10.1.2.2(ver) Date Release 5/24/95" ;
 /****************************************************************************
 *                                                                           *
 *                           S C C S   I N F O                               *
 *                                                                           *
 * @(#)  sem_oper.c; Rel: 10.1.2.2; Get date: 5/24/95 at 14:46:59
 * @(#)  Last delta: 5/24/95 at 14:46:52
 * @(#)  SCCS File: /taxi/sccs/s.sem_oper.c
 *                                                                           *
 *****************************************************************************/
