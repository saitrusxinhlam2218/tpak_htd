static char sz__FILE__[]="@(#)pi_fill_u.c	10.1.2.1(ver) Date Release 12/2/94" ;
 /****************************************************************************
 *                                                                           *
 *                           S C C S   I N F O                               *
 *                                                                           *
 * @(#)  pi_fill_u.c; Rel: 10.1.2.1; Get date: 4/19/95 at 08:45:58
 * @(#)  Last delta: 12/2/94 at 18:52:41
 * @(#)  SCCS File: /taxi/sccs/s.pi_fill_u.c
 *                                                                           *
 *****************************************************************************/
...
char excpt_fl[FLEET_MAX];			/* fleets selected for exception processing */
