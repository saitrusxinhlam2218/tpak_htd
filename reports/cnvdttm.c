static char sz__FILE__[]="@(#)cnvdttm.c	10.1(ver) Date Release 12/2/94" ;
 /****************************************************************************
 *                                                                           *
 *                           S C C S   I N F O                               *
 *                                                                           *
 * @(#)  cnvdttm.c; Rel: 5.1.0.0; Get date: 2/27/90 at 12:20:31
 * @(#)  Last delta: 12/14/89 at 16:56:53
 * @(#)  SCCS File: /taxi/sccs/s.cnvdttm.c
 *                                                                           *
 *****************************************************************************/
