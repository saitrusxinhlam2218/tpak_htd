static char sz__FILE__[]="@(#)read_fld.c	10.1(ver) Date Release 12/2/94" ;
 /****************************************************************************
 *                                                                           *
 *                           S C C S   I N F O                               *
 *                                                                           *
 * @(#)  read_fld.c; Rel: 5.2.0.0; Get date: 4/4/90 at 14:05:11
 * @(#)  Last delta: 12/27/89 at 17:22:31
 * @(#)  SCCS File: /taxi/sccs/s.read_fld.c
 *                                                                           *
 *****************************************************************************/
