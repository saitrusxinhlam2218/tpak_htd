...
*                 RCS INFO
*
*  @(#)  $RCSfile: rel_maint.h,v $
*  @(#)  $Revision: 1.2 $
*  @(#)  $Date: 1996/09/06 13:49:40 $
*  @(#)  $Author: jwelch $
*  @(#)  $Source: /taxi-scan/taxi_proj/cvs/taxi-scan/src/include/rel_maint.h,v $
*
*  Copyright (c) 1994 - MobileSoft Consulting, Inc. Woodinville WA
*
***********************************************************************/
#ident "@(#) head:$RCSfile: rel_maint.h,v $	$Revision: 1.2 $"
...
#define         REL_FILE               RELATIONS_FILE
#define         REL_FILE_ID            RELATIONS_FILE_ID
