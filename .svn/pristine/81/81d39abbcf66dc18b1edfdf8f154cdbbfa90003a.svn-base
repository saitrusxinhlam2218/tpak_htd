...
*  @(#)  $RCSfile: hash.c,v $
*  @(#)  $Revision: 1.2 $
*  @(#)  $Date: 2002/03/25 18:00:08 $
*  @(#)  $Author: jwelch $
*  @(#)  $Source: /taxi-scan/taxi_proj/cvs/taxi-scan/src/comms_proc/hash.c,v $
*
*  Copyright (c) 2000 - MobileSoft Consulting, Inc. Dublin OH
*
***********************************************************************/
#ident "@(#) head:$RCSfile: hash.c,v $	$Revision: 1.2 $"

static char rcsid[] = "$Id: hash.c,v 1.2 2002/03/25 18:00:08 jwelch Exp $";
