...
*  @(#)  $RCSfile: parman.h,v $
*  @(#)  $Revision: 2.0 $
*  @(#)  $Date: 2012/08/28 13:23:56 $
*  @(#)  $Author: taxiprod $
*  @(#)  $Source: /usr/users/jwelch/cvs_g7/taxi-g7/include/parman.h,v $
*
...
#define	MAXLEN_P_VALUE	32    /* Maimum length of the Parameter value string */
#define	MAXLEN_BM_VALUE	1     /* Maximum length of the Broadcast message value string (O/N)*/
