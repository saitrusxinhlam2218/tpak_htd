...
*                 RCS INFO
*
*  @(#)  $RCSfile: hol_common.c,v $
*  @(#)  $Revision: 1.2 $
*  @(#)  $Date: 1996/09/06 14:08:26 $
*  @(#)  $Author: jwelch $
*  @(#)  $Source: /taxi-scan/taxi_proj/cvs/taxi-scan/src/maint/hol_common.c,v $
*
*  Copyright (c) 1994 - MobileSoft Consulting, Inc. Woodinville WA
*
***********************************************************************/

static char rcsid[] = "$Id: hol_common.c,v 1.2 1996/09/06 14:08:26 jwelch Exp $";
		...
		if(c == YES || c == NO)
		  {
			...
			prt_error(catgets(HOL_MAINT_m_catd, 1, 
					HOL_MAINT_9, "Invalid entry, please enter a Y or N"));
			mvaddstr(DEL_ROW,DEL_COL,DELETE_HDR);
			refresh();
		}
	}
 ...
 */
		...
		switch (answer)
			...
			case M_CREATE:
				...
				break;
			default:
				prt_error(catgets(HOL_MAINT_m_catd, 1, 10, 
     ...
     int *erase_field;
{
  ...
  *erase_field = 0;
  switch( piu )
    {
    case F_YR:
      addstr( catgets( HOL_MAINT_m_catd, 1, HOL_MAINT_5, "Year" ) );
      break;
    case F_MONTH:
      addstr( catgets( HOL_MAINT_m_catd, 1, HOL_MAINT_6, "Month" ) );
      break;
    case F_DAY:
      addstr( catgets( HOL_MAINT_m_catd, 1, HOL_MAINT_7, "Day" ) );
      break;
    case F_DESCRIPT:
      addstr( catgets( HOL_MAINT_m_catd, 1, HOL_MAINT_8, "Description" ) );
      break;
    }
  refresh();
}
